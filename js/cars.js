document.addEventListener("DOMContentLoaded", function() {
        ...
        if (this.readyState == 4) {
            if (this.status == 200) {
                ...
                cars.forEach(element => {
                    ...
                    buttonCell.innerHTML = "<a class=\"a-button\" href=\"./car-details.php?id=" + element.ID + "\"><p>Zobacz szczegóły</p></a>";
                });
    ...
    ajax.open("GET", "./api/cars.php?type=" + (new URL(location.href)).searchParams.get("type"), true);
    ajax.send();
});